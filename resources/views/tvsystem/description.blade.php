  ...
  <div class="how-it-works _anim-items _anim-no-hide">
    <x-row sClass="howitworks">
      ...
      <x-item sClass="howitworks__desciptions">
        ...
        {{-- camera works --}}
        <div id="howitworks_slide2_descr"><p>Поворотное устройство медленно поворачивает камеру на 360 градусов, осматривая лесной массив площадью 30-60 км в зависимости от рельефа.</p></div>
        {{-- net --}}
