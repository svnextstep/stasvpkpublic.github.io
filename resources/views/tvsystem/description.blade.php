  ...
  <div class="slider" data-legend-parent>
    ...
    <div class="slider__content ts-brief"  data-legend-watch>
      ...
      <div class="ts-brief__item">
        ...
        <p>Пересечение зон наблюдения двух телекамер дают точные координаты возгорания. Сеть телесистем ВПК обеспечивает покрытие всей области наблюдения.</p>
      </div>
...
<section>
  ...
  <p class="_article _gor-center">Индивидуальные проекты предполагают дополнительные возможности в зависимости от потребностей хозяйства. </p>
  ...
  <div class="ts-features">
    ...
    <div class="ts-features-main">
      ...
      <x-ts-feature detailClass="ts-features-main__item-1" sTitle='Сеть телесистем'>
        ...
        Просмотр информации и управление всеми камерами из офисов лесничеств и лесхоза
      </x-ts-feature>
      
      <x-ts-feature detailClass="ts-features-main__item-2" sTitle='Сеть фотоловушек' sImg='projects/photo_traps.png'>
        <a href="{{route('photo_traps')}}">Скрытая сьемка событий</a>: наблюдение за животными, контроль лесных дорог, чистоты леса.
      </x-ts-feature>
      
      <x-ts-feature detailClass="ts-features-main__item-3" sTitle='Малые территории'>
        Наблюдение за територией лесничества, гаражей, <a href="{{route('control_sawmill')}}">теплиц, деревообрабатывающих предприятий</a>
      </x-ts-feature>
    </div>
    ...
    <x-row sClass="ts-features-adds">
      ...
      <x-item sClass="ts-features-adds__item">
        ...
        <div>на териториях лесхоза и лесничеств, беспроводная Wi-Fi связь</div>
      </x-item>
      ...
      <x-item sClass="ts-features-adds__item">
        ...
        <div>Селекторная связь и видеосовещания с лесничествами</div>
      </x-item>
  ...
  <div class="project-steps">
    <div class="project-steps__row">
      ...
      <x-anim-panel iId="step-install" sTitle="{{ __('messages.ts.title_project_stages_install') }}" sSlogan="быстро и качественно">
        ...
        <p>Реконструкция старых вышек лесхоза или монтаж новых вышек производства ВПК, модульная конструкция которых позволяет сделать это быстро и качественно. Монтаж телекамер и средств передачи данных на вышки.</p>

        <h5>Оборудование пункта наблюдения</h5>
        <p>Установка специализированного оборудования и программного обеспечения. Создание или дополнение цифровой карты лесных дорог. Монтаж навигационного оборудования.</p>
  ...
  <x-row>
    ...
    <x-item>
      <ul class="first-letter">
        ...
        <li>Изучение и внедрение новых технологий</li>
      </ul>
    </x-item>
  </x-row>
</section>
