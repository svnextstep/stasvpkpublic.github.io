...
<x-row>
  ...
  <x-item>
    <p>Фотоловушки предназначены для скрытой сьемки событий. Они маскируются под ствол дерева на лесных тропах и дорогах.</p>
    <div class="take-attantion">
      Сеть фотоловушек производства ВПК разрабатывается специально 
          для конкретного лесного хозяйства
    </div>
