  ...
  <x-item sClass="change-order">
    ...
    <div>
      ...
      <ul class="list--dotted">
        ...
        <li>Передача по радиоканалу зафиксированных данных на пост наблюдения</li>
  ...
  <x-item sClass='photo-traps'>
    <div>
     ...
     <x-params-list sClass='photo-traps__params' sLineAccent='hide'>
       ...
       <x-params-item sName="Фото">12 мегапикселей</x-params-item>
       ...
       <x-params-item sName="Оповещение">при нарушении зоны наблюдения</x-params-item>
     </x-params-list>
    </div>
