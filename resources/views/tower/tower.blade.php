  ...
  <div class="panel__row">
    <div class="panel__item _article-flex">
      <p>Старые вышки так же могут быть использованы в проектировании "СИСТЕМЫ НАБЛЮДЕНИЯ ЗА ЛЕСОМ". 
        Если их высоты достаточно, то производиться только ремонт и покраска вышки. Если нет, то расчитывается необходимая дополнительная высота. Затем реставрируется старая и наращивается легкосплавная вышка ВПК.</br>
