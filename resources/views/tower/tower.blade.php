...
<x-gallery-wrapper iId="tower-gallery">
  ...
  <x-gallery-item>
    ...
    <x-gallery-item-desc>
      <h5>Устойчивость</h5>
      <p>Вышка крепится тросами с трех сторон. Схема крепления тросов расчитана с запасом прочности.</p>
  ...
  <x-gallery-item>
    ...
    <x-gallery-item-desc>
      ...
      <p>Эти работы должны выполняться только квалифицированным ПЕРСОНАЛОМ.</p>
    </x-gallery-item-desc>
  </x-gallery-item>
  ...
  <div class="panel__row">
    <div class="panel__item _article-flex">
      <p>Старые вышки так же могут быть использованы в проектировании "СИСТЕМЫ НАБЛЮДЕНИЯ ЗА ЛЕСОМ". 
        Если их высоты достаточно, то производиться только ремонт и покраска вышки. Если нет, то расчитывается необходимая дополнительная высота. Затем реставрируется старая и наращивается легкосплавная вышка ВПК на 12-16м.</br>
      Итак, проект предусматривает модернизацию старых вышек:</p>
      
      <x-accents-list>
        <x-accents-item>ремонт</x-accents-item>
        <x-accents-item>покраска</x-accents-item>
        <x-accents-item>наращивание</x-accents-item>
      </x-accents-list>


      <p>Ремонт и покраска старой вышки может быть и отдельным заказом. А так же других <a  href="{{route('services')}}#tower_old">высотных конструкций</a>.</p>
